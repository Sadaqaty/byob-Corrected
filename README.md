...
# ToDos to SetUp
```
Change IP to C2_HOST Ip in Client.py at Line 122 at /web-gui/buildyourownbotnet/client.py
```
...
### Construction Correction Steps:
1) Correct Payloads generation ip in files (web-gui/buildyourownbotnet/client.py)